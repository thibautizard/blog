...
Plutôt qu'un familier `--status == pending` on écrira `style(--status: pending)` qui revient au même.
...
<div className="useful-links">
  ...
  - [The CSS if() function: Conditional styling will never be the same - Ikeh Akinyemi (LogRocket)](https://blog.logrocket.com/css-if-function-conditional-styling/)
</div>
