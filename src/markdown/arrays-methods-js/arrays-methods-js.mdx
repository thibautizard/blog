...
Pour des [raisons de rétrocompatibilité](https://github.com/getify/You-Dont-Know-JS/blob/2nd-ed/get-started/ch1.md#backwards--forwards), les anciennes méthodes mutables **ne seront certainement jamais supprimées** mais la prudence invite désormais à les éviter pour leur préférer leur homologues modernes.