...
<div className="useful-links">
  ...
  - <ExternalLink> <LinkWithGlimpse url="https://docs.npmjs.com/cli/v11/using-npm/scripts">Documentation npm — Scripts</LinkWithGlimpse> </ExternalLink>
  - <ExternalLink> <LinkWithGlimpse url="https://docs.npmjs.com/cli/v11/configuring-npm/package-json">Documentation npm — package.json</LinkWithGlimpse> </ExternalLink>
  - <ExternalLink> <LinkWithGlimpse url="https://nodejs.org/api/packages.html#subpath-imports">Documentation Node.js — Subpath imports</LinkWithGlimpse> </ExternalLink>
  - <ExternalLink> <LinkWithGlimpse url="https://thehackernews.com/2026/07/npm-12-disables-install-scripts-by.html">npm 12 Disables Install Scripts by Default (The Hacker News)</LinkWithGlimpse> </ExternalLink>
</div>
