...
import TwoPeoplePointingEachOtherMeme from "./assets/images/two-people-pointing-each-other-meme.webp";
import DemasquerMeme from "./assets/images/demasquer_meme.webp";
...
<Image src={TwoPeoplePointingEachOtherMeme} alt="Two identical people pointing at each other" className="mx-auto my-8 w-150 max-w-full"/>
...
<Image src={DemasquerMeme} alt="Le select est enfin dévoilé : il s'agit d'un bouton" className="mx-auto my-8" className="mx-auto my-8 w-175 max-w-full"/>
...
<div className="useful-links">
    ### Liens additionnels
    - <ExternalLink> <LinkWithGlimpse url="https://developer.chrome.com/blog/a-customizable-select">Chrome for Developers - The &lt;select&gt; element can now be customized with CSS</LinkWithGlimpse> </ExternalLink>
    - <ExternalLink> <LinkWithGlimpse url="https://una.im/select-updates/">Updates to the customizable select API</LinkWithGlimpse> </ExternalLink>
    - <ExternalLink> <LinkWithGlimpse url="https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Customizable_select">MDN - Customizable select elements</LinkWithGlimpse> </ExternalLink>
    - <ExternalLink> <LinkWithGlimpse url="https://chrome.dev/css-wrapped-2025/#customizable-select">CSS Wrapped 2025</LinkWithGlimpse> </ExternalLink>
</div>
