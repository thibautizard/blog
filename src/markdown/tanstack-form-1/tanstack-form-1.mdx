...
Compatible avec React, Vue, Solid — et bien d'autres frameworks et technologies front —, **[TanStack Form](https://tanstack.com/form/latest/docs/overview)** offre **un typage intégral de votre formulaire** qui sécurise et accélère le développement.
...
On va donc devoir passer par la méthode `form.handleSubmit()` pour **déclencher les étapes de validation** et nous renvoyer toutes les informations nécessaires à l'issue de celles-ci.
...
Ne reste plus qu'à **ajouter la validation des champs** et **gérer les erreurs**, des étapes que nous verrons dans [la partie suivante](/post/tanstack-form-2).
